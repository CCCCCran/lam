        ...
        <table class="order-item" v-for="(order, index) in myOrder.records" :key="order.id">
          ...
          <tbody>
            <tr v-for="(cart, index) in order.orderDetailList" :key="cart.id">
              ...
              <td rowspan="2" width="8%" v-if="index == 0" class="center">{{ order.consignee }}</td>
              <td rowspan="2" width="13%" v-if="index == 0" class="center">
                <ul class="unstyled">
                  <li>总金额¥{{ order.totalAmount }}.00</li>
                  <li>在线支付</li>
                </ul>
              </td>
              <td rowspan="2" width="8%" v-if="index == 0" class="center">
